<div>
    <form class="row g-3 mt-3" wire:submit.prevent="submit">
        ...
        <div class="col-md-6">
            ...
            <input type="text" wire:model="jenis_product" class="form-control @error('nama_product') is-invalid @enderror" id="inputAddress" placeholder="Contoh: Pakaian" required>
        ...
        <div class="col-md-6">
            ...
            <input type="number" wire:model="harga_product" class="form-control" id="inputPassword4" placeholder="Harga" min="1" required>
